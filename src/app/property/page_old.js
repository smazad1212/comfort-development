                        ...
                        <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="property-card magnetic-item">
                                <div className="property-img-wrap">
                                    <Link href="/property/comfort-shahjahan-manjil" className="property-img"><img src="assets/img/home2/property-img1.jpg" alt="" /></Link>
                                    <div className="price">
                                        <span>$1,50000</span>
                                    </div>
                                </div>
                                <div className="property-content">
                                    ...
                                    <h5><Link href="/property/comfort-shahjahan-manjil">Charming Family Home Luxury Living Room &amp;
                                        Garden.</Link></h5>
                                    <Link href="/property/comfort-shahjahan-manjil" className="primary-btn">
                                        View Details
