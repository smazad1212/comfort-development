...
const Header = () => {
  ...
  useEffect(() => {
    const debouncedHandleScroll = debounce(handleScroll, 10); // Adjust delay as needed
  ...
  return (
    <>
      <div className={`right-sidebar-menu ${state.isRightSidebar ? "show-right-menu" : ""}`}>
        ...
        <div className="sidebar-content-wrap">
          <div className="title-area">
            ...
            <h2>Connect With Comfort Development Ltd</h2>
      ...
      <div className="header-topbar-wrap">
        <header className={`header-area style-2 ${state.scrollY > 75 ? "sticky" : ""}`}>
          <div className={`d-flex flex-nowrap align-items-center justify-content-between`}>
              ...
              <ul className="menu-list">
                {
                  navData.map((data) => {
                    ...
                    return <li key={id}
                               className={`${icon === true ? "menu-item-has-children" : ""} ${isActive ? "active" : ""}`}>
            ...
            <div className="nav-right d-flex jsutify-content-end align-items-center">
              ...
              <Link href="/contact" className="primary-btn white d-lg-flex d-none">
                Contact Us
                <svg viewBox="0 0 13 20">
                  <polyline points="0.5 19.5 3 19.5 12.5 10 3 0.5"/>
                </svg>
              ...
              <div className="sidebar-button mobile-menu-btn" onClick={toggleSidebar}>
                <svg className="sidebar-toggle-button" width={25} height={25} viewBox="0 0 18 18"
