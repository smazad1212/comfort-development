          ...
          <div className="row gy-4 align-items-center justify-content-between mb-60 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="col-xl-5 col-lg-6 col-md-8">
              <div className="section-title white">
                ...
                <Link href="/property" className="primary-btn white">
                  View All Project
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="project-card">
                      <div className="project-img-wrap">
                        <Link href="/projects/project-details" className="project-img">
                      ...
                      <div className="project-content">
                        <span>Client: Last Wave Tech</span>
                        <h4><Link href="/projects/project-details">Unveiling Iconic Denies</Link></h4>
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide className="swiper-slide">
                    <div className="project-card">
                      ...
                      <div className="project-content">
                        ...
                        <h4><Link href="/projects/project-details">Constructing With Precision</Link></h4>
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide className="swiper-slide">
                    <div className="project-card">
                      ...
                      <div className="project-content">
                        ...
                        <h4><Link href="/projects/project-details">Crafting the Framework</Link></h4>
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide className="swiper-slide">
                    <div className="project-card">
                      ...
                      <div className="project-content">
                        ...
                        <h4><Link href="/projects/project-details">Construction Master Plan</Link></h4>
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide className="swiper-slide">
                    <div className="project-card">
                      ...
                      <div className="project-content">
                        ...
                        <h4><Link href="/projects/project-details">Project Build Vision</Link></h4>
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide className="swiper-slide">
                    <div className="project-card">
                      ...
                      <div className="project-content">
                        <span>Client: Triprex</span>
                        <h4><Link href="/projects/project-details">Project Construction Phases</Link></h4>
                      </div>
                    </div>
                  </SwiperSlide>
                </div>
