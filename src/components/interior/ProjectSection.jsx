              ...
              <div className="project-card3 magnetic-item">
                ...
                <div className="project-content-wrap">
                  <div className="project-content">
                    ...
                    <h3><Link href="/projects/project-details">Modern Minimalist Home Design</Link></h3>
                    <ul>
              ...
              <div className="project-card3 magnetic-item">
                ...
                <div className="project-content-wrap">
                  <div className="project-content">
                    ...
                    <h3><Link href="/projects/project-details">Timeless Vintage Interiors</Link></h3>
                    <ul>
              ...
              <div className="project-card3 magnetic-item">
                ...
                <div className="project-content-wrap">
                  <div className="project-content">
                    ...
                    <h3><Link href="/projects/project-details">Eco-Friendly Office Interiors</Link></h3>
                    <ul>
              ...
              <div className="project-card3 magnetic-item">
                ...
                <div className="project-content-wrap">
                  <div className="project-content">
                    ...
                    <h3><Link href="/projects/project-details">Minimalist Luxury Suite</Link></h3>
                    <ul>
                      <li><Link href="/project">Architecture</Link></li>
              ...
              <div className="project-card3 magnetic-item">
                ...
                <div className="project-content-wrap">
                  <div className="project-content">
                    ...
                    <h3><Link href="/projects/project-details">Luxury Urban Apartment Design</Link></h3>
                    <ul>
