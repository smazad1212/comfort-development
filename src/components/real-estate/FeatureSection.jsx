          ...
          <div className="row align-items-center">
                ...
                <div className="feature-content">
                  <div className="video-and-content">
                    ...
                    <div className="content">
                      <p>Comfort Development Ltd is a Dhaka-based real estate company, founded in 2014. With 30+ years in sectors like transport and agro-farming, we focus on building modern, efficient homes. We prioritize quality, transparency, and customer satisfaction, making us a trusted name.
                      </p>
                    </div>
                  </div>
                  <div className="feature-list">
                    ...
                    <ul>
                      <li><strong>Transparent Partnerships:</strong> We ensure transparency and fairness in every agreement with landowners and buyers.</li>
                      <li><strong>Lasting Relationships:</strong> We build enduring partnerships, offering continuous collaboration for landowners and ongoing support for buyers.</li>
                      <li><strong>Maximizing Value:</strong> We maximize property value for landowners and deliver quality homes for buyers.</li>
                      <li><strong>Timely Delivery:</strong> We meet deadlines, ensuring landowners see projects completed as planned and buyers receive their homes on time.</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-5 d-lg-block d-none wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="feature-img magnetic-item">
                <img src="https://vernex-next-js.vercel.app/assets/img/home2/home2-feature-img.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              <div className="single-countdown">
                <div className="number">
                  <h2 className="counter"><CountUp end={50} enableScrollSpy /></h2>
                  <span>+</span>
                </div>
                <span>Katha of land developed</span>
              </div>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-lg-center">
              <div className="single-countdown">
                <div className="number">
                  <h2 className="counter"><CountUp end={135} enableScrollSpy /></h2>
                  <span>k+</span>
                </div>
                <span>SqFt. constructed</span>
              </div>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-lg-center">
              <div className="single-countdown">
                ...
                <span>Floor built</span>
              </div>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-lg-center">
              <div className="single-countdown">
                <div className="number">
                  <h2 className="counter"><CountUp end={140} enableScrollSpy /></h2>
                  <span>+</span>
                </div>
                <span>Happy homes delivered</span>
              </div>
            </div>
          </div>
        </div>
