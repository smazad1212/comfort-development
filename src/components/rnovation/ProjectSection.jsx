                    ...
                    <div className="project-card3">
                      ...
                      <div className="project-content-wrap">
                        <div className="project-content">
                          ...
                          <h3><Link href="/projects/project-details">Dominating Auto Search</Link></h3>
                          <ul>
                    ...
                    <div className="project-card3">
                      ...
                      <div className="project-content-wrap">
                        <div className="project-content">
                          ...
                          <h3><Link href="/projects/project-details">Project Build Vision</Link></h3>
                          <ul>
                    ...
                    <div className="project-card3">
                      ...
                      <div className="project-content-wrap">
                        <div className="project-content">
                          ...
                          <h3><Link href="/projects/project-details">Unveiling Iconic Denies</Link></h3>
                          <ul>
                    ...
                    <div className="project-card3">
                      ...
                      <div className="project-content-wrap">
                        <div className="project-content">
                          ...
                          <h3><Link href="/projects/project-details">Build Master Plan</Link></h3>
                          <ul>
                            <li><Link href="/project">Architecture</Link></li>
                    ...
                    <div className="project-card3">
                      ...
                      <div className="project-content-wrap">
                        <div className="project-content">
                          ...
                          <h3><Link href="/projects/project-details">Creating with Precision</Link></h3>
                          <ul>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="project-card3">
                      ...
                      <div className="project-content-wrap">
                        <div className="project-content">
                          <span>Client: Triprex</span>
                          <h3><Link href="/projects/project-details">Crafting the Framework</Link></h3>
                          <ul>
                            <li><Link href="/project">Industrial</Link></li>
                            <li><Link href="/project">Residential</Link></li>
                          </ul>
